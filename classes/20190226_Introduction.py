...
# * I also work as data quality team lead at [Jumpshot](https://www.jumpshot.com)
...
# 
# All **resources** will be on [GitHub](https://github.com/matejmojzes/18heur-2019). Any meaningful pull requests will be taken into account during your evaluation.
...
# #### Notes
# 
# * Subscribe to the [mailing list](https://goo.gl/forms/sQyogwk7Rzpz9Uky1).
...
# * **Enter your results into [Google Form questionnaire](https://goo.gl/forms/FnGaHaFXBnt1olQj2)**
