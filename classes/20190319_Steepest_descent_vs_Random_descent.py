...
# ## Assignment
# 
# * Investigate how many evaluations were made for some certain level $h$ of the local search phase of Shoot & Go heuristic. Evalute this statistics on both `Sum` and `SumSin` functions.
